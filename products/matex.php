...
<div class="main">
	...
	<div class="product-view">
		...
		<div class="product-banner" style="background-image:url('https://192.168.0.5/product/matex/image/matex.jpg');"></div>
		...
		<video class="product-video" onclick="(this.paused) ? this.play(): this.pause();">
			<source type="video/mp4" src="https://192.168.0.5/product/matex/video/matex-fold.mp4">
		</video>
		...
		<div class="product-banner" style="background-image:url('https://192.168.0.5/product/matex/image/matex-power.png');"></div>
	</div>
</div>
